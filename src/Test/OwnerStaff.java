...
public class OwnerStaff {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@id='name']")).sendKeys("UNI");
        ...
        driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//input[@id='businessName']")).sendKeys("TEST");
        driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS) ;
        ...
        driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("anamika.kumari+stafff@jellyfishtechnologies.com");
        driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
